...
## Selected revision
byte-c1-r02-desktop.png; exact correction prompts retained in sibling JSON; actual native and display-size PNG review completed in image-review.md. User approval pending.
