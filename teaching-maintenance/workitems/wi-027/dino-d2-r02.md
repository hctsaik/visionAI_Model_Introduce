...
Keep washer defect at 3 oclock and exact corresponding crops. Replace 真實影像中的小缺口 with 原圖示意中的小缺口. Lowresolution missingnotch input should actually hide notch; do not label sharp clear notch photo 縮小後. Show visibly blurred lowresolution edge thumbnail beside its similar feature vector. One paired normal/notched highresolution crops in finalgroup, no automatic defectscore.
