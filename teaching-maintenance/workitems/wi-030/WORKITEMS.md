...
- 狀態：進行中；本輪替代已完成WI-028作為當前目標。基準12fc9ff且Git乾淨；尚未產圖／整合／測試，使用者核准pending。
- 接續唯一細項：teaching-images/vision-ai-model-selection/workitems/wi-030/PLAN.md。下一步保存12課基準、實看參考，先PatchCore原型再擴展。
