...
C=W.parents[1]
BASE='http://127.0.0.1:8000/docs/index.html'
...
for name,cmd in [
    ...
    (W/f'recheck-reliability-{name}.txt').write_text(p.stdout+p.stderr+f'\nEXIT: {p.returncode}\n',encoding='utf8')
...
with sync_playwright() as pw:
    ...
    browser.close()
(W/'recheck-reliability-evidence.json').write_text(json.dumps(results,ensure_ascii=False,indent=2)+'\n',encoding='utf8')
